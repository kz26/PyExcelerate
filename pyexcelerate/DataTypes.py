...
class DataTypes(object):
    ...
    def to_excel_date(d):
        if isinstance(d, datetime):
            ...
            excel_date = (delta.days + (float(delta.seconds) + float(delta.microseconds) / 1E6) / (60 * 60 * 24) + 1)  # flake8: noqa
            ...
            return DataTypes.to_excel_date(datetime(*(DataTypes.EXCEL_BASE_DATE.timetuple()[:3]), hour=d.hour, minute=d.minute, second=d.second, microsecond=d.microsecond)) - 1  # flake8: noqa
